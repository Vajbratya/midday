...
export function AskAiBar({ title, description }: AskAiBarProps) {
  const prompt = encodeURIComponent(
    `I'm reading the Laudos.AI documentation about "${title}". ${description ? `The page describes: ${description}` : ""}\n\nHelp me understand this topic better. What are the key things I should know about ${title.toLowerCase()} in Laudos.AI?`,
  );

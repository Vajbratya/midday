    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
      ...
      <div className="lg:col-span-2">
        <h1 className="font-serif text-3xl lg:text-4xl text-foreground mb-4">
          Melhor alternativa ao {competitor.name} para o fluxo radiológico
        </h1>
        <p className="font-sans text-base text-muted-foreground leading-normal mb-8 max-w-2xl">
          {competitor.description} Compare recursos, valor operacional e entenda
          por que serviços de radiologia estão migrando para a Laudos.AI.
        </p>

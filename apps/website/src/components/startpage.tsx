...
const features = [
  {
    title: "Todos os exames e achados no mesmo fluxo",
    subtitle:
      "Laudo, templates, integrações e contexto clínico conectados para o radiologista trabalhar sem alternar entre sistemas.",
    mobileSubtitle: "Laudo, templates e contexto conectados no mesmo fluxo.",
    illustration: "animation",
  },
  {
    title: "O laudo sai estruturado",
    subtitle:
      "Você fala como pensa. A plataforma organiza o conteúdo em estrutura radiológica pronta para revisar e assinar.",
    mobileSubtitle: "Você dita. A plataforma estrutura o laudo.",
    illustration: "animation",
  },
  {
    title: "Comunicação crítica com prova",
    subtitle:
      "CRIT fecha o ciclo de notificação de achados críticos com SLA, rastreabilidade e auditoria institucional.",
    mobileSubtitle: "CRIT registra ciência, SLA e auditoria.",
    illustration: "animation",
  },
];
...
const videos = [
  {
    ...
    title: "Visão geral",
    subtitle:
      "Veja como o sagittal.health reduz digitação, padroniza o laudo e fecha o fluxo crítico sem atrito.",
  ...
  },
  {
    ...
    subtitle:
      "Tudo o que entra no fluxo do radiologista fica visível no mesmo sistema, do exame ao laudo final.",
  ...
  },
  {
    ...
    subtitle:
      "Pedidos, anexos e referências podem entrar no fluxo e aparecer junto do caso certo.",
    url: "https://cdn.midday.ai/videos/login-video.mp4", // Replace with actual video URL
  },
  {
    id: "time-tracking",
    title: "Produtividade",
    subtitle:
      "Entenda onde o tempo clínico está indo e identifique gargalos de operação.",
    url: "https://cdn.midday.ai/videos/login-video.mp4", // Replace with actual video URL
  },
  {
    id: "invoicing",
    title: "Editor",
    subtitle:
      "Estruture o laudo com IA assistiva, templates e consistência institucional.",
    url: "https://cdn.midday.ai/videos/login-video.mp4", // Replace with actual video URL
  },
  {
    id: "customers",
    title: "Instituições",
    subtitle:
      "Governança, equipes e operação compartilhada em um ambiente preparado para escala.",
    url: "https://cdn.midday.ai/videos/login-video.mp4", // Replace with actual video URL
  },
  {
    id: "files",
    title: "Templates",
    subtitle:
      "Modelos e descritores centralizados para manter padronização sem retrabalho.",
    url: "https://cdn.midday.ai/videos/login-video.mp4", // Replace with actual video URL
  },
];
          ...
          <div className="flex-1 lg:flex-none flex flex-col justify-center md:justify-start md:pt-16 lg:pt-48 items-center space-y-8 lg:space-y-0 z-20 px-3 sm:px-4 lg:px-0 lg:max-w-[1400px] lg:mx-auto lg:w-full lg:mb-12 xl:mb-12 2xl:mb-12 3xl:mb-16">
            <div className="flex flex-col items-center w-full text-center space-y-6 lg:space-y-8">
              <div className="space-y-5 lg:space-y-6 max-w-3xl 3xl:max-w-5xl mx-auto px-2 lg:px-0">
                ...
                >
                  Novo editor mobile sagittal.health
                ...
                <p className="text-muted-foreground text-base lg:text-lg leading-relaxed font-sans max-w-xl mx-auto">
                  Dite o achado, receba o laudo estruturado, comunique casos
                  críticos com segurança e integre tudo ao fluxo real da sua
                  operação.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center gap-3 pt-2">
                ...
                <p className="text-muted-foreground text-xs font-sans">
                  30 dias grátis · Sem instalação obrigatória
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative overflow-hidden">
              ...
              >
                <Image
                  ...
                  alt="Prévia do editor do sagittal.health"
                  fill
                  fetchPriority="high"
                  quality={50}
                  sizes="100vw"
              ...
              <div className="absolute inset-0 flex items-center justify-center p-0 lg:p-4 z-[2]">
                <div className="relative lg:static scale-[0.95] md:scale-100 lg:scale-100 lg:h-full lg:flex lg:flex-col lg:items-center lg:justify-center">
                  <Image
                    ...
                    alt="Editor do sagittal.health com busca, frases prontas, CRIT e laudo estruturado."
                    width={1536}
                    height={859}
                    className="w-full h-auto md:!scale-[0.92] lg:!scale-100 lg:object-contain lg:max-w-[92%] 2xl:max-w-[82%] rounded-[18px] border border-white/8 shadow-[0_30px_90px_rgba(0,0,0,0.6)] transition-all duration-700 ease-out"
                    style={{
              ...
              <button
                ...
                className={`hidden absolute inset-0 z-[4] flex items-center justify-center pointer-events-none transition-opacity duration-500 delay-300 ${
                  isDashboardDarkLoaded ? "opacity-100" : "opacity-0"
                }`}

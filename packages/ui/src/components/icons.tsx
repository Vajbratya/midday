...
export const Icons = {
  LogoSmall: (props: SVGIconProps) => (
    ...
    >
      <g fill="currentColor">
        <rect x="9.4" y="1.2" width="9.2" height="5.2" rx="1.9" />
        <rect x="6.1" y="5.6" width="5.2" height="5.2" rx="1.9" />
        <rect x="16.7" y="5.6" width="5.2" height="5.2" rx="1.9" />
        <rect x="9.4" y="10.8" width="9.2" height="5.2" rx="1.9" />
        <rect x="6.1" y="15.9" width="5.2" height="5.2" rx="1.9" />
        <rect x="16.7" y="15.9" width="5.2" height="5.2" rx="1.9" />
        <rect x="9.4" y="21.1" width="9.2" height="5.2" rx="1.9" />
      </g>
    </SVGIcon>
  ),
  Logo: (props: any) => (
